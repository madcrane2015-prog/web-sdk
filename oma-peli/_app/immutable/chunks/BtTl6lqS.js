...
`),z(lr,b),z(cr,_),z(dr,$),x(Ls,"style",`color: ${E??""};`),z(pr,`${a(es)??""}%`),x(Rs,"style",`color: ${O??""};`),z(ur,`${a(ts)??""}%`),z(fr,a(yt)),z(hr,a(ss)),z(gr,`${a(Fo)??""}%`),He.disabled=a(le).length===0,x(He,"style",`
      ...
      `),x(pt,"style",`
        ...
        font-size: 11px;
        margin-bottom: 5px;
      `),z(vr,`🎵 Music: ${(a(de)?"ON":"OFF")??""}`),Bs.disabled=a(U),x(Bs,"style",`
        width: 100%;
        padding: 5px;
