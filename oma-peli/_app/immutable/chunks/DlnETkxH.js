...
`;let it=null;class jr{constructor(){it||(it=URL.createObjectURL(new Blob([Ci],{type:"application/javascript"}))),this.worker=new Worker(it)}}jr.revokeObjectURL=function(){it&&(URL.revokeObjectURL(it),it=null)};let br=0,ra;class Bi{constructor(){this._initialized=!1,this._createdWorkers=0,this._workerPool=[],this._queue=[],this._resolveHash={}}isImageBitmapSupported(){return this._isImageBitmapSupported!==void 0?this._isImageBitmapSupported:(this._isImageBitmapSupported=new Promise(e=>{const{worker:s}=new da;s.addEventListener("message",a=>{s.terminate(),da.revokeObjectURL(),e(a.data)})}),this._isImageBitmapSupported)}loadImageBitmap(e,s){var a;return this._run("loadImageBitmap",[e,(a=s==null?void 0:s.data)==null?void 0:a.alphaMode])}async _initWorkers(){this._initialized||(this._initialized=!0)}_getWorker(){ra===void 0&&(ra=navigator.hardwareConcurrency||4);let e=this._workerPool.pop();return!e&&this._createdWorkers<ra&&(this._createdWorkers++,e=new jr().worker,e.addEventListener("message",s=>{this._complete(s.data),this._returnWorker(s.target),this._next()})),e}_returnWorker(e){this._workerPool.push(e)}_complete(e){e.error!==void 0?this._resolveHash[e.uuid].reject(e.error):this._resolveHash[e.uuid].resolve(e.data),this._resolveHash[e.uuid]=null}async _run(e,s){await this._initWorkers();const a=new Promise((n,o)=>{this._queue.push({id:e,arguments:s,resolve:n,reject:o})});return this._next(),a}_next(){if(!this._queue.length)return;const e=this._getWorker();if(!e)return;const s=this._queue.pop(),a=s.id;this._resolveHash[br]={resolve:s.resolve,reject:s.reject},e.postMessage({data:s.arguments,uuid:br++,id:a})}}const xr=new Bi,Fi=[".jpeg",".jpg",".png",".webp",".avif"],Mi=["image/jpeg","image/png","image/webp","image/avif"];async function Wi(t,e){var n;const s=await pe.get().fetch(t);if(!s.ok)throw new Error(`[loadImageBitmap] Failed to fetch ${t}: ${s.status} ${s.statusText}`);const a=await s.blob();return((n=e==null?void 0:e.data)==null?void 0:n.alphaMode)==="premultiplied-alpha"?createImageBitmap(a,{premultiplyAlpha:"none"}):createImageBitmap(a)}const Dr={name:"loadTextures",extension:{type:C.LoadParser,priority:lt.High,name:"loadTextures"},config:{preferWorkers:!0,preferCreateImageBitmap:!0,crossOrigin:"anonymous"},test(t){return dt(t,Mi)||ct(t,Fi)},async load(t,e,s){var o;let a=null;globalThis.createImageBitmap&&this.config.preferCreateImageBitmap?this.config.preferWorkers&&await xr.isImageBitmapSupported()?a=await xr.loadImageBitmap(t,e):a=await Wi(t,e):a=await new Promise((i,l)=>{a=new Image,a.crossOrigin=this.config.crossOrigin,a.src=t,a.complete?i(a):(a.onload=()=>{i(a)},a.onerror=l)});const n=new Tr({resource:a,alphaMode:"premultiply-alpha-on-upload",resolution:((o=e.data)==null?void 0:o.resolution)||va(t),...e.data});return ga(n,s,t)},unload(t){t.destroy(!0)}},Ur=[".mp4",".m4v",".webm",".ogg",".ogv",".h264",".avi",".mov"],Ni=Ur.map(t=>`video/${t.substring(1)}`);function ji(t,e,s){s===void 0&&!e.startsWith("data:")?t.crossOrigin=Ui(e):s!==!1&&(t.crossOrigin=typeof s=="string"?s:"anonymous")}function Di(t){return new Promise((e,s)=>{t.addEventListener("canplaythrough",a),t.addEventListener("error",n),t.load();function a(){o(),e()}function n(i){o(),s(i)}function o(){t.removeEventListener("canplaythrough",a),t.removeEventListener("error",n)}})}function Ui(t,e=globalThis.location){if(t.startsWith("data:"))return"";e||(e=globalThis.location);const s=new URL(t,document.baseURI);return s.hostname!==e.hostname||s.port!==e.port||s.protocol!==e.protocol?"anonymous":""}const Gi={name:"loadVideo",extension:{type:C.LoadParser,name:"loadVideo"},test(t){const e=dt(t,Ni),s=ct(t,Ur);return e||s},async load(t,e,s){var p,v;const a={...Js.defaultOptions,resolution:((p=e.data)==null?void 0:p.resolution)||va(t),alphaMode:((v=e.data)==null?void 0:v.alphaMode)||await Io(),...e.data},n=document.createElement("video"),o={preload:a.autoLoad!==!1?"auto":void 0,"webkit-playsinline":a.playsinline!==!1?"":void 0,playsinline:a.playsinline!==!1?"":void 0,muted:a.muted===!0?"":void 0,loop:a.loop===!0?"":void 0,autoplay:a.autoPlay!==!1?"":void 0};Object.keys(o).forEach(f=>{const m=o[f];m!==void 0&&n.setAttribute(f,m)}),a.muted===!0&&(n.muted=!0),ji(n,t,a.crossorigin);const i=document.createElement("source");let l;if(t.startsWith("data:"))l=t.slice(5,t.indexOf(";"));else if(!t.startsWith("blob:")){const f=t.split("?")[0].slice(t.lastIndexOf(".")+1).toLowerCase();l=Js.MIME_TYPES[f]||`video/${f}`}return i.src=t,l&&(i.type=l),new Promise(f=>{const m=async()=>{const g=new Js({...a,resource:n});n.removeEventListener("canplay",m),e.data.preload&&await Di(n),f(ga(g,s,t))};n.addEventListener("canplay",m),n.appendChild(i)})},unload(t){t.destroy(!0)}},Gr={extension:{type:C.ResolveParser,name:"resolveTexture"},test:Dr.test,parse:t=>{var e;return{resolution:parseFloat(((e=jt.RETINA_PREFIX.exec(t))==null?void 0:e[1])??"1"),format:t.split(".").pop(),src:t}}},Hi={extension:{type:C.ResolveParser,priority:-2,name:"resolveJson"},test:t=>jt.RETINA_PREFIX.test(t)&&t.endsWith(".json"),parse:Gr.parse};class Vi{constructor(){this._detections=[],this._initialized=!1,this.resolver=new jt,this.loader=new hi,this.cache=Pe,this._backgroundLoader=new ni(this.loader),this._backgroundLoader.active=!0,this.reset()}async init(e={}){var o,i;if(this._initialized){We("[Assets]AssetManager already initialized, did you load before calling this Assets.init()?");return}if(this._initialized=!0,e.defaultSearchParams&&this.resolver.setDefaultSearchParams(e.defaultSearchParams),e.basePath&&(this.resolver.basePath=e.basePath),e.bundleIdentifier&&this.resolver.setBundleIdentifier(e.bundleIdentifier),e.manifest){let l=e.manifest;typeof l=="string"&&(l=await this.load(l)),this.resolver.addManifest(l)}const s=((o=e.texturePreference)==null?void 0:o.resolution)??1,a=typeof s=="number"?[s]:s,n=await this._detectFormats({preferredFormats:(i=e.texturePreference)==null?void 0:i.format,skipDetections:e.skipDetections,detections:this._detections});this.resolver.prefer({params:{format:n,resolution:a}}),e.preferences&&this.setPreferences(e.preferences)}add(e){this.resolver.add(e)}async load(e,s){this._initialized||await this.init();const a=Er(e),n=wt(e).map(l=>{if(typeof l!="string"){const p=this.resolver.getAlias(l);return p.some(v=>!this.resolver.hasKey(v))&&this.add(l),Array.isArray(p)?p[0]:p}return this.resolver.hasKey(l)||this.add({alias:l,src:l}),l}),o=this.resolver.resolve(n),i=await this._mapLoadToResolve(o,s);return a?i[n[0]]:i}addBundle(e,s){this.resolver.addBundle(e,s)}async loadBundle(e,s){this._initialized||await this.init();let a=!1;typeof e=="string"&&(a=!0,e=[e]);const n=this.resolver.resolveBundle(e),o={},i=Object.keys(n);let l=0,p=0;const v=()=>{s==null||s(++l/p)},f=i.map(m=>{const g=n[m];return p+=Object.keys(g).length,this._mapLoadToResolve(g,v).then(z=>{o[m]=z})});return await Promise.all(f),a?o[e[0]]:o}async backgroundLoad(e){this._initialized||await this.init(),typeof e=="string"&&(e=[e]);const s=this.resolver.resolve(e);this._backgroundLoader.add(Object.values(s))}async backgroundLoadBundle(e){this._initialized||await this.init(),typeof e=="string"&&(e=[e]);const s=this.resolver.resolveBundle(e);Object.values(s).forEach(a=>{this._backgroundLoader.add(Object.values(a))})}reset(){this.resolver.reset(),this.loader.reset(),this.cache.reset(),this._initialized=!1}get(e){if(typeof e=="string")return Pe.get(e);const s={};for(let a=0;a<e.length;a++)s[a]=Pe.get(e[a]);return s}async _mapLoadToResolve(e,s){const a=[...new Set(Object.values(e))];this._backgroundLoader.active=!1;const n=await this.loader.load(a,s);this._backgroundLoader.active=!0;const o={};return a.forEach(i=>{const l=n[i.src],p=[i.src];i.alias&&p.push(...i.alias),p.forEach(v=>{o[v]=l}),Pe.set(p,l)}),o}async unload(e){this._initialized||await this.init();const s=wt(e).map(n=>typeof n!="string"?n.src:n),a=this.resolver.resolve(s);await this._unloadFromResolved(a)}async unloadBundle(e){this._initialized||await this.init(),e=wt(e);const s=this.resolver.resolveBundle(e),a=Object.keys(s).map(n=>this._unloadFromResolved(s[n]));await Promise.all(a)}async _unloadFromResolved(e){const s=Object.values(e);s.forEach(a=>{Pe.remove(a.src)}),await this.loader.unload(s)}async _detectFormats(e){let s=[];e.preferredFormats&&(s=Array.isArray(e.preferredFormats)?e.preferredFormats:[e.preferredFormats]);for(const a of e.detections)e.skipDetections||await a.test()?s=await a.add(s):e.skipDetections||(s=await a.remove(s));return s=s.filter((a,n)=>s.indexOf(a)===n),s}get detections(){return this._detections}setPreferences(e){this.loader.parsers.forEach(s=>{s.config&&Object.keys(s.config).filter(a=>a in e).forEach(a=>{s.config[a]=e[a]})})}}const nt=new Vi;Ne.handleByList(C.LoadParser,nt.loader.parsers).handleByList(C.ResolveParser,nt.resolver.parsers).handleByList(C.CacheParser,nt.cache.parsers).handleByList(C.DetectionParser,nt.detections);Ne.add(oi,li,ii,pi,di,fi,ui,mi,yi,Ti,Ri,Dr,Gi,ri,ai,Gr,Hi);const yr={loader:C.LoadParser,resolver:C.ResolveParser,cache:C.CacheParser,detection:C.DetectionParser};Ne.handle(C.Asset,t=>{const e=t.ref;Object.entries(yr).filter(([s])=>!!e[s]).forEach(([s,a])=>Ne.add(Object.assign(e[s],{extension:e[s].extension??a})))},t=>{const e=t.ref;Object.keys(yr).filter(s=>!!e[s]).forEach(s=>Ne.remove(e[s]))});class Yi extends Co{constructor(e,s){const{text:a,resolution:n,style:o,anchor:i,width:l,height:p,roundPixels:v,...f}=e;super({...f}),this.batched=!0,this._resolution=null,this._autoResolution=!0,this._didTextUpdate=!0,this._styleClass=s,this.text=a??"",this.style=o,this.resolution=n??null,this.allowChildren=!1,this._anchor=new Bo({_onUpdate:()=>{this.onViewUpdate()}}),i&&(this.anchor=i),this.roundPixels=v??!1,l!==void 0&&(this.width=l),p!==void 0&&(this.height=p)}get anchor(){return this._anchor}set anchor(e){typeof e=="number"?this._anchor.set(e):this._anchor.copyFrom(e)}set text(e){e=e.toString(),this._text!==e&&(this._text=e,this.onViewUpdate())}get text(){return this._text}set resolution(e){this._autoResolution=e===null,this._resolution=e,this.onViewUpdate()}get resolution(){return this._resolution}get style(){return this._style}set style(e){var s;e||(e={}),(s=this._style)==null||s.off("update",this.onViewUpdate,this),e instanceof this._styleClass?this._style=e:this._style=new this._styleClass(e),this._style.on("update",this.onViewUpdate,this),this.onViewUpdate()}get width(){return Math.abs(this.scale.x)*this.bounds.width}set width(e){this._setWidth(e,this.bounds.width)}get height(){return Math.abs(this.scale.y)*this.bounds.height}set height(e){this._setHeight(e,this.bounds.height)}getSize(e){return e||(e={}),e.width=Math.abs(this.scale.x)*this.bounds.width,e.height=Math.abs(this.scale.y)*this.bounds.height,e}setSize(e,s){typeof e=="object"?(s=e.height??e.width,e=e.width):s??(s=e),e!==void 0&&this._setWidth(e,this.bounds.width),s!==void 0&&this._setHeight(s,this.bounds.height)}containsPoint(e){const s=this.bounds.width,a=this.bounds.height,n=-s*this.anchor.x;let o=0;return e.x>=n&&e.x<=n+s&&(o=-a*this.anchor.y,e.y>=o&&e.y<=o+a)}onViewUpdate(){this.didViewUpdate||(this._didTextUpdate=!0),super.onViewUpdate()}_getKey(){return`${this.text}:${this._style.styleKey}:${this._resolution}`}destroy(e=!1){super.destroy(e),this.owner=null,this._bounds=null,this._anchor=null,(typeof e=="boolean"?e:e!=null&&e.style)&&this._style.destroy(e),this._style=null,this._text=null}}function Xi(t,e){let s=t[0]??{};return(typeof s=="string"||t[1])&&(Ft(Mt,`use new ${e}({ text: "hi!", style }) instead`),s={text:s,style:t[1]}),s}class Ki extends Yi{constructor(...e){const s=Xi(e,"Text");super(s,Lr),this.renderPipeId="text"}updateBounds(){const e=this._bounds,s=this._anchor,a=Wo.measureText(this._text,this._style),{width:n,height:o}=a;e.minX=-s._x*n,e.maxX=e.minX+n,e.minY=-s._y*o,e.maxY=e.minY+o}}const Qi="1.1.8",Zi={version:Qi};var qi=Q('<div class="win-label svelte-27a1cu">BIG WIN!</div> <div class="win-amount-display svelte-27a1cu"> </div>',1),Ji=wr('<use href="#sparkle" class="sparkle svelte-27a1cu"></use>'),el=wr('<use href="#vinyl"></use>'),tl=Q('<div><!> <svg class="vinyl-canvas svelte-27a1cu" viewBox="0 0 1024 800" xmlns="http://www.w3.org/2000/svg"><defs class="svelte-27a1cu"><symbol id="vinyl" viewBox="-200 -200 400 400" class="svelte-27a1cu"><circle cx="0" cy="0" r="180" fill="#0b0b0b" class="svelte-27a1cu"></circle><circle cx="0" cy="0" r="150" fill="none" stroke="#1a1a1a" stroke-width="2" opacity="0.3" class="svelte-27a1cu"></circle><circle cx="0" cy="0" r="120" fill="none" stroke="#1a1a1a" stroke-width="2" opacity="0.25" class="svelte-27a1cu"></circle><circle cx="0" cy="0" r="90" fill="none" stroke="#1a1a1a" stroke-width="1.5" opacity="0.2" class="svelte-27a1cu"></circle><circle cx="0" cy="0" r="55" fill="var(--label-color)" class="svelte-27a1cu"></circle><circle cx="0" cy="0" r="6" fill="#ffffff" class="svelte-27a1cu"></circle><ellipse cx="-15" cy="-15" rx="20" ry="15" fill="#ffffff" opacity="0.3" transform="rotate(-30)" class="svelte-27a1cu"></ellipse></symbol><symbol id="sparkle" viewBox="-12 -12 24 24" class="svelte-27a1cu"><polygon points="0,-10 3,-3 10,0 3,3 0,10 -3,3 -10,0 -3,-3" fill="#ffd966" class="svelte-27a1cu"></polygon><circle cx="0" cy="0" r="2" fill="#ffffff" class="svelte-27a1cu"></circle></symbol><symbol id="confetti" viewBox="-3 -3 6 6" class="svelte-27a1cu"><circle cx="0" cy="0" r="2" fill="var(--confetti-color)" class="svelte-27a1cu"></circle></symbol></defs><!><!></svg></div>');function sl(t,e){fa(e,!0);let s=oa(e,"winLevel",3,"small"),a=oa(e,"winAmount",3,0),n=R(!1),o=R(!1);const i={small:{vinyls:5,sparkles:8,maxRadius:100},medium:{vinyls:12,sparkles:16,maxRadius:140},jackpot:{vinyls:24,sparkles:30,maxRadius:180}},l=Ue(()=>i[s()]),p=["#f04e37","#ffd966","#ff8533","#4ecdc4","#ff6b9d"];function v(P){const X=[],Se=r(l).maxRadius;for(let de=0;de<P;de++){const Ae=Math.PI*2*de/P+Math.random()*.4,fe=Math.random()*Se*.7+Se*.2;X.push({x:512+Math.cos(Ae)*fe,y:400+Math.sin(Ae)*fe,rotation:Math.random()*30-15,scale:.3+Math.random()*.25,delay:de*.05,color:p[de%p.length]})}return X}function f(P){const X=[];for(let re=0;re<P;re++)X.push({x:100+Math.random()*824,y:50+Math.random()*700,delay:Math.random()*.8,duration:.6+Math.random()*.4,rotation:Math.random()*360});return X}const m=Ue(()=>v(r(l).vinyls)),g=Ue(()=>f(r(l).sparkles));function z(){y(n,!0),y(o,!0),setTimeout(()=>{y(o,!1),setTimeout(()=>{var P;y(n,!1),(P=e.onComplete)==null||P.call(e)},500)},s()==="jackpot"?4e3:s()==="medium"?3e3:2500)}function T(){y(o,!1),setTimeout(()=>{y(n,!1)},500)}var te=_r(),H=Oe(te);{var L=P=>{var X=tl();let re;var ce=b(X);{var Se=se=>{var ne=qi(),xe=d(Oe(ne),2),Ie=b(xe,!0);x(xe),ie(kt=>W(Ie,kt),[()=>a().toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})]),j(se,ne)};le(ce,se=>{a()>0&&se(Se)})}var de=d(ce,2),Ae=d(b(de));Nt(Ae,17,()=>r(g),Wt,(se,ne)=>{var xe=Ji();ie(()=>A(xe,"style",`
          ...
          `)}),j(se,xe)}),x(de),x(X),ie(()=>re=ia(X,1,"vinyl-win-container svelte-27a1cu",null,re,{visible:r(o),hiding:!r(o)})),j(P,X)};le(H,P=>{r(n)&&P(L)})}return j(t,te),ua({show:z,hide:T})}var al=so('<script src="https://cdnjs.cloudflare.com/ajax/libs/howler/2.2.4/howler.min.js" class="svelte-2k82zv"><\/script><!---->',1),rl=Q('<p style="color: red;" class="svelte-2k82zv"><strong class="svelte-2k82zv">Error:</strong> </p>'),nl=Q('<div class="svelte-2k82zv"> </div>'),ol=Q('<details class="svelte-2k82zv"><summary class="svelte-2k82zv"> </summary> <!></details>'),il=Q(`<div style="
    position: fixed;
    top: 10px;
    left: 10px;
...
${r(ge).join(`
`)}`,u=new Blob([c],{type:"text/plain"}),w=URL.createObjectURL(u),h=document.createElement("a");h.href=w,h.download=`win-log-${Date.now()}.txt`,h.click(),URL.revokeObjectURL(w)}function nn(){y(ge,be([]))}function on(){r(Y)||(y(Y,!0),y($e,10),y(Ce,0),Re(Et),console.log("🎰 TEST MODE: Free spins activated! 10 spins granted."),Kt())}const ln={k:.08,j:.07,i:.07,c:.07,d:.07,b:.07,a:.07,f:.06,e:.05,g:.04,l:.1,h:0,emptyslot:.25},cn={k:0,j:0,i:0,c:.07,d:.07,b:.07,a:.07,f:.14,e:.12,g:.11,l:.1,h:0,emptyslot:.25};function ka(c){if(c===6)return Math.random()<.55?"h":"emptyslot";const u=r(Y)?cn:ln,w=Math.random();let h=0;const _=Ie.filter(E=>E!=="h"),k=_.reduce((E,O)=>E+u[O],0);for(const E of _)if(h+=u[E]/k,w<h)return E;return"f"}function Aa(){const c=[];for(let u=0;u<a;u++){const w=ka(u);c.push(w),Re(Tt),w==="emptyslot"&&Re(as)}return c}function za(c){return c<3?{col:0,row:c}:c<6?{col:1,row:c-3}:c===6?{col:2,row:0}:c<10?{col:3,row:c-7}:{col:4,row:c-10}}function vt(c,u){return c===0?u:c===1?3+u:c===2?6:c===3?7+u:c===4?10+u:-1}function dn(){if(r(Y)){const c=Math.random();return c<.7?3:c<.92?5:10}else{const c=Math.random();return c<.7?1:c<.92?2:3}}const fn={k:{3:.2,4:.6,5:1.5},j:{3:.4,4:1,5:2.5},i:{3:.4,4:1,5:2.5},c:{3:.8,4:2,5:5},d:{3:.8,4:2,5:5},b:{3:1.5,4:4,5:8},a:{3:1.5,4:4,5:8},f:{3:3,4:8,5:20},e:{3:5,4:10,5:25},g:{3:7,4:15,5:50},h:{},l:{},emptyslot:{}};function un(){var G;const c=[],u=[];for(let S=0;S<a;S++)gt[S]==="l"&&u.push(S);if(u.length>=5){const S=u.length;y($e,r($e)+S),r(Y)?console.log(`🎰 FREE SPINS RETRIGGERED! +${S} FREE SPINS! Total: ${r($e)}`):(y(Y,!0),y(Ce,0),Re(Et),console.log(`🎰 FREE SPINS TRIGGERED! ${u.length} scatters = ${S} FREE SPINS!`),Kt()),c.push({symbol:"l",count:u.length,payout:0,positions:u,multiplier:1})}const w=[];for(let S=0;S<3;S++)for(let $=0;$<3;$++)for(let B=0;B<1;B++)for(let F=0;F<3;F++)for(let M=0;M<3;M++){const N=[vt(0,S),vt(1,$),vt(2,B),vt(3,F),vt(4,M)];w.push(N)}console.log(`Generated ${w.length} possible paths (should be 81)`);const h=[];for(const S of w){const $=S.map(N=>gt[N]);if($[0]==="emptyslot"||$[0]==="l")continue;let B=null;for(let N=0;N<$.length;N++)if($[N]!=="h"&&$[N]!=="emptyslot"&&$[N]!=="l"){B=$[N];break}if(!B)continue;let F=0;const M=new Set;for(let N=0;N<S.length;N++){const Fe=S[N],{col:rt}=za(Fe),ue=$[N];(ue===B||ue==="h")&&M.add(rt)}for(let N=0;N<5&&M.has(N);N++)F++;if(F>=3){const Fe=S[0]%3;h.push({symbol:B,length:F,path:S.slice(0,F),startRow:Fe})}}const _=[],k=new Map;for(const S of h){const $=`${S.symbol}-${S.path.join(",")}`;k.has($)||k.set($,[]),k.get($).push(S)}for(const[S,$]of k.entries()){const B=Math.max(...$.map(M=>M.length)),F=$.find(M=>M.length===B);F&&_.push(F)}const E=[],O=new Map;for(const S of _)O.has(S.symbol)||O.set(S.symbol,[]),O.get(S.symbol).push(S);const U=[];for(const[S,$]of O.entries()){const B=Math.max(...$.map(M=>M.length)),F=$.filter(M=>M.length===B);U.push(...F)}const J=new Map;for(const S of U){const $=`${S.symbol}-${S.length}`;J.has($)||J.set($,[]),J.get($).push(S)}const ee=U.length>0?dn():1;for(const[S,$]of J.entries()){const B=$[0],F=(G=fn[B.symbol])==null?void 0:G[B.length];if(F!==void 0&&F>0){const M=new Map;for(const ue of $)for(let oe=0;oe<ue.length;oe++)M.has(oe)||M.set(oe,new Set),M.get(oe).add(ue.path[oe]);let N=1;for(let ue=0;ue<B.length;ue++){const oe=M.get(ue);N*=oe?oe.size:1}const Fe=F*r(q)*N*ee;console.log(`  ${B.length}x${B.symbol}: ${N} ways × ${F}x × ${r(q)} bet × ${ee} mult = ${Fe}`);const rt=new Set;for(const ue of $)ue.path.forEach(oe=>rt.add(oe));E.push({symbol:B.symbol,count:B.length,payout:Fe,positions:Array.from(rt),multiplier:ee})}}return c.push(...E),c}let me=R(0),Je=R(be([])),Be=R(!1),et=R(!1);const Sa={a:"Hot Rod",b:"Jacket",c:"Roller Skates",d:"Microphone",e:"Blonde",f:"Brunette",g:"Rockabilly",h:"WILD",i:"Burger",j:"Fries",k:"Milkshake",l:"SCATTER",emptyslot:"Empty"};function rs(c){if(!r(Ee)||!Gt[c])return;const u=Gt[c];u.currentTime=0,u.play().catch(w=>{console.warn("Äänen toisto epäonnistui:",c,w)})}function pn(c){mt.forEach(u=>D.stage.removeChild(u)),mt=[],c.forEach(u=>{u.positions.forEach(w=>{const h=tt[w],_=new ea().rect(0,0,fe,se).fill({color:16776960,alpha:0}).stroke({color:16766720,width:4});_.x=h.container.x,_.y=h.container.y,D.stage.addChild(_),mt.push(_);let k=0,E=1;const O=.05;D.ticker.add(()=>{k+=E*O,k>=.4&&(E=-1),k<=0&&(E=1),_.alpha=.5+k})})})}function ns(){mt.forEach(c=>D.stage.removeChild(c)),mt=[]}let gt=Aa(),os,D,tt=[],mt=[];class hn{constructor(u,w){we(this,"index");we(this,"container");we(this,"offset",0);we(this,"speed",0);we(this,"targetSpeed",30);we(this,"state","idle");we(this,"stopDelay",0);we(this,"bounceOffset",0);we(this,"bounceSpeed",0);we(this,"bounceFrames",0);this.index=u,this.container=w}start(u){this.state="spinning",this.speed=0,r(K)==="slow"?this.targetSpeed=20:r(K)==="medium"?this.targetSpeed=35:this.targetSpeed=50,this.stopDelay=u}startSynchronized(u){const w=60+u*Yr;this.start(w)}update(){if(this.state!=="idle"){if(this.state==="spinning"&&(this.speed<this.targetSpeed&&(this.speed+=2),this.stopDelay>0?this.stopDelay--:this.state="slowing"),this.state==="slowing"){const u=r(K)==="slow"?.88:r(K)==="medium"?.92:.95;this.speed*=u,this.speed<2.5&&(this.state="bouncing",this.bounceSpeed=-8,this.bounceFrames=0,this.speed=0,this.offset=0,rs("stop"),Jr())}this.state==="bouncing"&&(this.bounceFrames++,this.bounceSpeed+=.8,this.bounceOffset+=this.bounceSpeed,this.bounceOffset>3&&(this.bounceOffset=3,this.bounceSpeed*=-.6),(this.bounceFrames>45||Math.abs(this.bounceSpeed)<.5&&Math.abs(this.bounceOffset)<1)&&(this.state="stopped",this.bounceOffset=0,this.bounceSpeed=0)),this.speed>0&&(this.offset+=this.speed,this.offset>=xe&&(this.offset=0,gt[this.index]=ka(this.index)))}}draw(){const u=this.container;u.removeChildren();const w=gt[this.index];if(!w||!St||!St[w])return;const h=St[w];if(!h)return;const _=this.offset+this.bounceOffset,k=new It(h);k.width=fe,k.height=se,k.x=0,k.y=_,u.addChild(k)}}let is=R(1);Sr(async()=>{D=new Mr,await D.init({width:n,height:o,background:"#001a33"}),os.appendChild(D.canvas);const c=()=>{const h=window.innerWidth,_=window.innerHeight,k=h/n,E=_/o,O=Math.min(k,E,1);y(is,be(O)),D.stage.scale.set(O),D.renderer.resize(n*O,o*O)};c(),window.addEventListener("resize",c);const u={};try{y(pt,"Loading background and UI images..."),_e.push(`Loading background: ${Ut}`),_e.push(`Loading reel frames: ${ma}`),_e.push(`Loading logo: ${ba}`),await nt.load([{alias:"background",src:Ut},{alias:"reelframes",src:ma},{alias:"logo",src:ba}]),Xe=Ge.from("background"),ft=Ge.from("reelframes"),ut=Ge.from("logo"),console.log("✅ Background texture created:",Xe.width,"x",Xe.height),console.log("✅ Reel frames texture created:",ft.width,"x",ft.height),console.log("✅ Logo texture created:",ut.width,"x",ut.height),_e.push("✅ All UI images loaded"),y(pt,"Loading symbols...");const h=[];for(const _ of Ie)h.push({alias:_,src:Dt[_]});await nt.load(h);for(const _ of Ie){const k=Dt[_];_e.push(`Loading symbol ${_}: ${k}`);try{const E=Ge.from(_);u[_]=E,console.log(`✅ Symbol ${_} loaded:`,E.width,"x",E.height),_e.push(`✅ Symbol ${_} loaded`)}catch(E){const O=`❌ Failed to load symbol ${_} from ${k}: ${E}`;throw _e.push(O),console.error(O),new Error(O)}}St=u,y(pt,"Assets loaded successfully!")}catch(h){y(Ke,`Asset loading failed: ${h}`),_e.push(r(Ke)),console.error(r(Ke));return}console.log("Ladataan ääniefektit...");for(const[h,_]of Object.entries(Hr)){const k=new Audio;k.src=_,k.preload="auto",k.volume=.7,k.load(),k.addEventListener("error",()=>{console.log(`Äänitiedostoa ei löydy: ${_} (käytetään hiljaista placeholderia)`)}),Gt[h]=k}if(console.log("Taustakuva ladattu, tekstuuri:",Xe),Xe){const h=new It(Xe);D.renderer.width/D.renderer.height;const _=h.texture.width/h.texture.height;let k;k=D.renderer.height/h.texture.height,k*=Se,h.scale.set(k),h.x=(D.renderer.width-h.width)/2,h.y=(D.renderer.height-h.height)/2+ce,D.stage.addChild(h),console.log("Taustakuva lisätty:",de,"mode, size:",h.width.toFixed(0),"x",h.height.toFixed(0),"image aspect:",_.toFixed(2),"scale:",k.toFixed(2),"pos:",h.x.toFixed(0),h.y.toFixed(0))}else console.error("Taustakuva ei ole saatavilla!");[{x:70,y:120},{x:203,y:120},{x:345,y:120},{x:487,y:120},{x:620,y:120}].map(h=>({x:h.x+l,y:h.y+p})),tt=[];for(let h=0;h<a;h++){const _=za(h),k=_.col,E=_.row,O=300+k*(fe+20),U=250+E*(se+15),J=h===6?O+f:O,ee=h===6?U+v:U,G=new pa;G.x=J+l,G.y=ee+p;const S=[16711680,65280,255,16776960,16711935,65535,16753920,8388736,32768,128,16744448,8388863,33023],$=new ea().rect(0,0,fe,se).fill({color:S[h],alpha:.3});$.x=G.x,$.y=G.y,D.stage.addChild($);const B=new Lr({fontFamily:"Arial",fontSize:20,fill:16777215,fontWeight:"bold",stroke:{color:0,width:2}}),F=new Ki({text:h.toString(),style:B});F.x=G.x+5,F.y=G.y+5,D.stage.addChild(F);const M=new ea().rect(0,0,fe,se).fill(16777215);M.x=G.x,M.y=G.y,G.mask=M,D.stage.addChild(M),D.stage.addChild(G),tt.push(new hn(h,G))}if(ft){const h=new It(ft);h.scale.set(1),h.x=250,h.y=200,D.stage.addChild(h),Xt=h,y(Yt,be(h.width)),console.log("Reel frames lisätty:",h.width.toFixed(0),"x",h.height.toFixed(0)),console.log("Control panel leveys päivitetty:",r(Yt).toFixed(0))}if(ut){const h=new It(ut);h.scale.set(P),h.x=(D.renderer.width-h.width)/2+X,h.y=re,D.stage.addChild(h),console.log("Logo lisätty päällimmäiseen layeriin:",h.width.toFixed(0),"x",h.height.toFixed(0))}ya(),D.ticker.add(vn)});function vn(){for(const c of tt)c.update(),c.draw();if(!r(Be)&&!qt&&tt.every(c=>c.state==="stopped")){qt=!0,Qr();const c=un();console.log(`Checking wins, found ${c.length} wins`),c.length>0?(y(Je,be(c)),y(me,be(c.reduce((u,w)=>u+w.payout,0))),an(r(Ze),c,r(me)),gn(r(me)),y(Be,!0),y(tn,be(Date.now())),console.log(`🎉 VOITTO! ${r(me)} pistettä! Uusi saldo: ${r(Te)}`),console.log(`isShowingWin set to: ${r(Be)}, totalWin: ${r(me)}`),c.forEach(u=>{const w=u.multiplier?` (${u.multiplier}x multiplier)`:"";console.log(`${u.count}x ${u.symbol} = ${u.payout} pistettä${w}`)}),pn(c),rs("win"),r(ve)&&!De&&(De=!0,Le=window.setTimeout(()=>{r(Be)&&r(ve)&&(console.log("Autoplay: Auto-closing win popup after 1.5s"),y(Be,!1),ns()),Le=window.setTimeout(()=>{De=!1,cs()},200)},1500))):(console.log("No wins found this spin"),r(ve)&&!De&&(De=!0,Le=window.setTimeout(()=>{De=!1,cs()},1e3))),r(Y)&&r($e)===0&&(console.log(`🎰 FREE SPINS ENDED! Total won: ${r(Ce)}`),setTimeout(()=>{alert(`Free Spins Ended!
Total Won: ${r(Ce).toFixed(2)}`),y(Y,!1),y(Ce,0),Kt()},2e3))}}function Ea(){if(V&&r(ye)&&!V.playing()&&(V.play(),console.log("🎵 Background music started on first spin")),Zr(),r(Y)&&r($e)>0)Re($e,-1),Re(ss),console.log(`🎰 FREE SPIN! Remaining: ${r($e)}`);else if(!r(Y)){if(r(Te)<r(q)){alert(`Not enough credits! Balance: ${r(Te)}, Bet: ${r(q)}`),ls();return}y(Te,r(Te)-r(q)),Re(Ze),y(qe,r(qe)+r(q))}Le!==null&&(clearTimeout(Le),Le=null),y(Je,be([])),y(me,0),y(Be,!1),qt=!1,ns(),gt=Aa(),tt.forEach((c,u)=>{c.startSynchronized(u)}),rs("spin")}function gn(c){if(y(Te,r(Te)+c),y(ht,r(ht)+c),r(Y)&&y(Ce,r(Ce)+c),c>0){Re(Jt);const u=c/r(q);u>=10&&en(),Ye&&(u>=50?Ye.show():u>=20?setTimeout(()=>Ye.show(),200):u>=10&&setTimeout(()=>Ye.show(),400))}}function Ta(){r(q)<Zt&&y(q,be(Math.min(r(q)+1,Zt)))}function La(){r(q)>wa&&y(q,be(Math.max(r(q)-1,wa)))}function mn(){y(q,Zt)}function bt(c){y(ve,!0),y(Qe,be(c)),y(je,!1),cs()}function ls(){y(ve,!1),y(Qe,0),De=!1,Le!==null&&(clearTimeout(Le),Le=null)}function cs(){if(!r(ve)||r(Qe)<=0){ls();return}console.log(`Autoplay: Starting spin ${r(Qe)} rounds left`),Ea(),Re(Qe,-1)}function bn(){confirm("Reset all statistics?")&&(y(Ze,0),y(qe,0),y(ht,0),y(Jt,0),y(Et,0),y(ss,0),y(Tt,0),y(as,0))}var $a=ml();$o(c=>{var u=al();d(Oe(u)),j(c,u)});var Ra=Oe($a);{var xn=c=>{var u=il(),w=d(b(u),2),h=d(b(w));x(w);var _=d(w,2);{var k=B=>{var F=rl(),M=d(b(F));x(F),ie(()=>W(M,` ${r(Ke)??""}`)),j(B,F)};le(_,B=>{r(Ke)&&B(k)})}var E=d(_,2),O=d(b(E));O.nodeValue=` ${ze??""}`,x(E);var U=d(E,2),J=d(b(U));J.nodeValue=` ${Ut??""}`,x(U);var ee=d(U,2),G=d(b(ee));x(ee);var S=d(ee,2);{var $=B=>{var F=ol(),M=b(F),N=b(M);x(M);var Fe=d(M,2);Nt(Fe,17,()=>_e,Wt,(rt,ue)=>{var oe=nl(),Zn=b(oe,!0);x(oe),ie(()=>W(Zn,r(ue))),j(rt,oe)}),x(F),ie(()=>W(N,`Log (${_e.length??""})`)),j(B,F)};le(S,B=>{_e.length>0&&B($)})}x(u),ie(()=>{W(h,` ${r(pt)??""}`),W(G,` ${Dt.a??""}`)}),j(c,u)};le(Ra,c=>{(r(pt)!=="Assets loaded successfully!"||r(Ke))&&c(xn)})}var Pa=d(Ra,2);{var yn=c=>{var u=dl(),w=d(b(u),2),h=b(w);x(w);var _=d(w,2);Nt(_,17,()=>r(Je),Wt,(U,J)=>{var ee=ll(),G=b(ee);x(ee),ie(S=>W(G,`${r(J).count??""} × ${Sa[r(J).symbol]??""} = ${S??""} pistettä`),[()=>r(J).payout.toFixed(2)]),j(U,ee)});var k=d(_,2);{var E=U=>{var J=cl(),ee=b(J),G=b(ee);x(ee),x(J),ie(()=>W(G,`✨ ${r(Je)[0].multiplier??""}x WIN MULTIPLIER! ✨`)),j(U,J)};le(k,U=>{r(Je).length>0&&r(Je)[0].multiplier>1&&U(E)})}var O=d(k,2);x(u),ie(()=>W(h,`${r(me)??""} pistettä`)),I("click",O,()=>{y(Be,!1),ns(),console.log("Win popup closed, ready for next spin")}),j(c,u)};le(Pa,c=>{r(me)>0&&r(Be)&&c(yn)})}var Oa=d(Pa,2);{var _n=c=>{var u=fl(),w=d(b(u),8);x(u),I("click",w,()=>{y(et,!1)}),j(c,u)};le(Oa,c=>{r(et)&&c(_n)})}var Ia=d(Oa,2),ds=b(Ia),fs=b(ds);A(fs,"style",`
        position: absolute;
        top: 0;
        left: 0;
        width: ${n}px;
        height: ${o}px;
      `),cr(fs,c=>os=c,()=>os);var Lt=d(fs,2),Ca=b(Lt);{var wn=c=>{var u=ul(),w=Oe(u),h=d(b(w),2),_=b(h,!0);x(h),x(w);var k=d(w,2),E=d(b(k),2),O=b(E,!0);x(E),x(k),ie(U=>{W(_,r($e)),W(O,U)},[()=>r(Ce).toFixed(2)]),j(c,u)};le(Ca,c=>{r(Y)&&c(wn)})}var us=d(Ca,2),Ba=d(b(us),2),kn=b(Ba,!0);x(Ba),x(us);var Fa=d(us,2),Ma=d(b(Fa),2),An=b(Ma,!0);x(Ma),x(Fa),x(Lt);var ps=d(Lt,2),Wa=d(b(ps),2),Na=b(Wa),hs=d(Na,2),zn=b(hs,!0);x(hs);var ja=d(hs,2),Sn=d(ja,2);x(Wa),x(ps);var Da=d(ps,2),vs=d(Da,2),Ua=d(b(vs),2);Ua.textContent=`v${s}`;var gs=d(Ua,2),Ga=d(b(gs),2),En=b(Ga,!0);x(Ga),x(gs);var ms=d(gs,2),Ha=d(b(ms),2),Tn=b(Ha,!0);x(Ha),x(ms);var bs=d(ms,2),Va=d(b(bs),2),Ln=b(Va,!0);x(Va),x(bs);var xs=d(bs,2),ys=d(b(xs),2),$n=b(ys);x(ys),x(xs);var _s=d(xs,2),ws=d(b(_s),2),Rn=b(ws);x(ws),x(_s);var ks=d(_s,2),Ya=d(b(ks),2),Pn=b(Ya,!0);x(Ya),x(ks);var As=d(ks,2),Xa=d(b(As),2),On=b(Xa,!0);x(Xa),x(As);var zs=d(As,2),Ka=d(b(zs),2),In=b(Ka);x(Ka),x(zs);var Qa=d(zs,2),Za=d(Qa,2),st=b(Za),Cn=b(st);x(st);var $t=d(st,2),xt=d($t,2),Bn=b(xt);x(xt);var Ss=d(xt,2);x(Za),x(vs);var Es=d(vs,2),Fn=b(Es);{var Mn=c=>{var u=pl(),w=d(b(u),2),h=b(w);x(w);var _=d(w,2);x(u),ie(()=>W(h,`${r(Qe)??""} left`)),I("click",_,ls),j(c,u)},Wn=c=>{var u=vl(),w=Oe(u),h=d(w,2);{var _=k=>{var E=hl(),O=d(b(E),2),U=d(O,2),J=d(U,2),ee=d(J,2),G=d(ee,2),S=d(G,2);x(E),I("click",O,()=>bt(10)),I("click",U,()=>bt(100)),I("click",J,()=>bt(1e3)),I("click",ee,()=>bt(1e4)),I("click",G,()=>bt(1e5)),I("click",S,()=>{y(je,!1)}),j(k,E)};le(h,k=>{r(je)&&k(_)})}I("click",w,()=>{y(je,!r(je))}),j(c,u)};le(Fn,c=>{r(ve)?c(Mn):c(Wn,!1)})}x(Es);var at=d(Es,2),Nn=b(at,!0);x(at);var Rt=d(at,2),Ts=b(Rt);A(Ts,"src",`${Z??""}/Control_leftend.png`),A(Ts,"style",`height: ${g}px; flex-shrink: 0;`);var Pt=d(Ts,2);A(Pt,"style",`
    flex-grow: 1;
    height: ${g}px;
  ...
  `);var Ls=b(Pt),qa=d(b(Ls),2),$s=b(qa);A($s,"style",`
          ...
          `);var Rs=d($s,2),jn=b(Rs,!0);x(Rs);var Ja=d(Rs,2);A(Ja,"style",`
            width: 40px;
            height: 40px;
            ...
            cursor: pointer;
            background-color: transparent;
          `),x(qa),x(Ls);var Ps=d(Ls,2);A(Ps,"src",`${Z??""}/Control_divider.png`),A(Ps,"style",`height: ${g*.8}px; flex-shrink: 0;`);var Os=d(Ps,2),er=d(b(Os),2),Dn=b(er,!0);x(er),x(Os);var Is=d(Os,2);A(Is,"src",`${Z??""}/Control_divider.png`),A(Is,"style",`height: ${g*.8}px; flex-shrink: 0;`);var Cs=d(Is,2),Bs=b(Cs),Fs=b(Bs);x(Bs),x(Cs);var Ms=d(Cs,2);A(Ms,"src",`${Z??""}/Control_divider.png`),A(Ms,"style",`height: ${g*.8}px; flex-shrink: 0;`);var Ws=d(Ms,2),Ns=b(Ws),Un=d(Ns,2);x(Ws);var js=d(Ws,2);A(js,"src",`${Z??""}/Control_divider.png`),A(js,"style",`height: ${g*.8}px; flex-shrink: 0;`);var Ds=d(js,2),Ot=b(Ds);A(Ot,"style",`
          width: 50px;
          height: 50px;
          ...
          cursor: pointer;
          background-color: transparent;
        `);var Us=d(Ot,2),Gn=b(Us,!0);x(Us);var Hn=d(Us,2);{var Vn=c=>{var u=gl(),w=d(b(u),2),h=d(w,2),_=d(h,2);x(u),ie(()=>{A(w,"style",`
            ...
            `),A(_,"style",`
              ...
              font-size: 12px;
              transition: all 0.2s;
            `)}),I("click",w,()=>{y(K,"slow"),y(Ve,!1)}),I("click",h,()=>{y(K,"medium"),y(Ve,!1)}),I("click",_,()=>{y(K,"fast"),y(Ve,!1)}),j(c,u)};le(Hn,c=>{r(Ve)&&c(Vn)})}x(Ds);var Gs=d(Ds,2);A(Gs,"src",`${Z??""}/Control_divider.png`),A(Gs,"style",`height: ${g*.8}px; flex-shrink: 0;`);var Hs=d(Gs,2),Vs=b(Hs),Yn=d(Vs,2);x(Hs);var Ys=d(Hs,2);A(Ys,"src",`${Z??""}/Control_divider.png`),A(Ys,"style",`height: ${g*.8}px; flex-shrink: 0;`);var Xs=d(Ys,2),tr=d(b(Xs),2),Xn=b(tr,!0);x(tr),x(Xs);var Ks=d(Xs,2);A(Ks,"src",`${Z??""}/Control_divider.png`),A(Ks,"style",`height: ${g*.8}px; flex-shrink: 0;`);var sr=d(Ks,2);A(sr,"style",`
        width: 50px;
        height: 50px;
        ...
        cursor: pointer;
        background-color: transparent;
      `),x(Pt);var ar=d(Pt,2);A(ar,"src",`${Z??""}/Control_rightend.png`),A(ar,"style",`height: ${g}px; flex-shrink: 0;`),x(Rt);var Kn=d(Rt,2);const Qn=Ue(()=>r(me)/r(q)>=50?"jackpot":r(me)/r(q)>=20?"medium":"small");cr(sl(Kn,{get winLevel(){return r(Qn)},get winAmount(){return r(me)}}),c=>Ye=c,()=>Ye),x(ds),x(Ia),ie((c,u,w,h,_,k,E,O,U)=>{A(ds,"style",`
    position: relative;
    width: ${n*r(is)}px;
    height: ${o*r(is)}px;
  `),A(Lt,"style",`
      ...
      z-index: 1500;
      min-width: 180px;
    `),W(kn,c),W(An,r(q)),W(zn,r(q)),W(En,u),W(Tn,w),W(Ln,h),A(ys,"style",`color: ${_??""};`),W($n,`${r(es)??""}%`),A(ws,"style",`color: ${k??""};`),W(Rn,`${r(ts)??""}%`),W(Pn,r(Et)),W(On,r(ss)),W(In,`${r(sn)??""}%`),st.disabled=r(ge).length===0,A(st,"style",`
        width: 100%;
        padding: 5px;
      ...
      `),W(Cn,`Download Win Log (${r(ge).length??""})`),$t.disabled=r(ge).length===0,A($t,"style",`
        width: 100%;
        padding: 5px;
      ...
      `),A(xt,"style",`
        ...
        font-size: 11px;
        margin-bottom: 5px;
      `),W(Bn,`🎵 Music: ${(r(ye)?"ON":"OFF")??""}`),Ss.disabled=r(Y),A(Ss,"style",`
        width: 100%;
        padding: 5px;
    ...
    align-items: center;
    justify-content: center;
  `),A(at,"title",r(Ee)?"Mykistä äänet":"Laita äänet päälle"),W(Nn,r(Ee)?"🔊":"🔇"),A(Rt,"style",`
  position: absolute;
  left: 50%;
  top: 50%;
  transform: translate(
  ...
  align-items: center;
  z-index: 1000;
`),W(jn,E),W(Dn,O),ia(Bs,1,`play-button-wrapper ${(r(Qt)?"glare-animate":"")??""}`,"svelte-2k82zv"),Fs.disabled=r(ve),A(Fs,"style",`
            width: 130px;
            height: 130px;
          ...
          cursor: pointer;
          background-color: transparent;
        `),A(Un,"src",`${Z??""}/${(r(ve)?"Control_bar_select.png":"Control_bar_deselect.png")??""}`),A(Ot,"title",`Spin Speed: ${(r(K)==="slow"?"Slow":r(K)==="medium"?"Medium":"Fast")??""}`),W(Gn,r(K)==="slow"?"Slow":r(K)==="medium"?"Med":"Fast"),A(Vs,"style",`
          width: 50px;
          height: 50px;
          ...
          cursor: pointer;
          background-color: transparent;
        `),A(Yn,"src",`${Z??""}/${(r(At)?"Control_bar_select.png":"Control_bar_deselect.png")??""}`),W(Xn,U)},[()=>r(Te).toLocaleString(),()=>r(Ze).toLocaleString(),()=>r(qe).toLocaleString(),()=>r(ht).toLocaleString(),()=>parseFloat(r(es))>=95?"#00ff00":parseFloat(r(es))>=85?"#ffff00":"#ff6666",()=>parseFloat(r(ts))>=30?"#00ff00":parseFloat(r(ts))>=20?"#ffff00":"#ff6666",()=>r(q).toFixed(2),()=>r(Te).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}),()=>r(me).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})]),I("click",Na,La),I("click",ja,Ta),I("click",Sn,mn),I("click",Da,()=>{y(et,!r(et))}),I("click",Qa,bn),I("click",st,rn),I("click",$t,nn),I("click",xt,qr),I("click",Ss,on),I("click",at,()=>{y(Ee,!r(Ee))}),I("click",$s,La),I("click",Ja,Ta),I("click",Fs,Ea),I("click",Ns,()=>{y(je,!r(je))}),I("click",Ot,()=>{y(Ve,!r(Ve))}),I("click",Vs,()=>{y(At,!r(At))}),I("click",sr,()=>{y(et,!r(et))}),j(t,$a),ua()}var xl=Q('<p class="error svelte-8ys286">❌ Väärä salasana!</p>'),yl=Q('<div class="auth-container svelte-8ys286"><div class="auth-box svelte-8ys286"><h2 class="svelte-8ys286">🎰 Peli Access</h2> <p class="svelte-8ys286">Anna salasana päästäksesi peliin:</p> <form><input type="password" placeholder="Salasana..." class="password-input svelte-8ys286" autocomplete="off"> <button type="submit" class="submit-btn svelte-8ys286">Kirjaudu sisään</button></form> <!></div></div>');function _l(t,e){fa(e,!1);let s=oa(e,"isAuthenticated",12,!1),a=na(""),n=na(!1);const o="slot2024";function i(){r(a)===o?(s(!0),sessionStorage.setItem("gameAuthenticated","true")):(y(n,!0),y(a,""),setTimeout(()=>y(n,!1),3e3))}Sr(()=>{s(sessionStorage.getItem("gameAuthenticated")==="true")}),ao();var l=_r(),p=Oe(l);{var v=f=>{var m=yl(),g=b(m),z=d(b(g),4),T=b(z);Go(T),Lo(2),x(z);var te=d(z,2);{var H=L=>{var P=xl();j(L,P)};le(te,L=>{r(n)&&L(H)})}x(g),x(m),Vo(T,()=>r(a),L=>y(a,L)),I("submit",z,Yo(i)),j(f,m)};le(p,f=>{s()||f(v)})}j(t,l),ua()}var wl=Q('<div style="position: fixed; top: 10px; left: 10px; z-index: 9999; color: white; font-weight: bold;">HELLO MAD CRANE 👋 (oma peli käynnissä)</div> <!>',1),kl=Q("<!> <!>",1);function Bl(t){let e=na(!1);var s=kl(),a=Oe(s);_l(a,{get isAuthenticated(){return r(e)},set isAuthenticated(i){y(e,i)},$$legacy:!0});var n=d(a,2);{var o=i=>{var l=wl(),p=d(Oe(l),2);bl(p,{}),j(i,l)};le(n,i=>{r(e)&&i(o)})}j(t,s)}export{Ir as A,Rr as C,ti as R,Qo as S,Cr as V,Bl as _,Ko as u};
