...
- Execute Phase 04 from `OMA_PELI_UI_REFACTOR_PHASES.md`: recompose mobile landscape and short screens.
- Preserve the tokenized modal/top/spin behavior introduced in Phase 02.
- Preserve the Phase 03 portrait status strip while improving compact landscape and short-screen density in later phases.
